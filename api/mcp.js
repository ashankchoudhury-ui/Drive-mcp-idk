...
export default async function handler(req, res) {
  if (req.method === 'OPTIONS') {
    ...
    res.setHeader(
      ...
      'Content-Type, Authorization, Accept, MCP-Protocol-Version, Last-Event-ID'
    );
  ...
  if (!bearerToken(req)) {
    res.setHeader(
      'WWW-Authenticate',
      'Bearer realm="Google Drive MCP", scope="https://www.googleapis.com/auth/drive.readonly"'
    );
